...
public class SwapVariable {
    public static void main(String[] args) {
        ...
        int num1 , num2;
        System.out.println("For Swappingbthe Variables you should give the integer data to the Variables...");
        ...
        System.out.println("The data of your first Variable has been changed to" + num2);
        System.out.println("The data of your second Variable has been changed to" + num1);
